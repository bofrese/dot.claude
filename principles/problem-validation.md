...
Compact reference for validating problems before building solutions. Load when working on problem discovery, validation, or early-stage product decisions.
