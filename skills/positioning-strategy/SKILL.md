...
1. Adjacent segments, similar needs
2. Adjacent use cases, same segment
3. Broader market (slowly)
...
Pick two dimensions that matter to customers (e.g., "ease of use" vs "power/flexibility").
...
**How:**
1. Talk to customers who chose you (why?)
2. Talk to those who chose alternatives (why not?)
3. Identify pattern (who values your attributes most?)
4. Narrow or shift to that segment
5. Update messaging and GTM
